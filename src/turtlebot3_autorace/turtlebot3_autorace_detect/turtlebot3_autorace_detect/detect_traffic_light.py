...
from std_msgs.msg import String  # 상단 import 필요
...
class DetectTrafficLight(Node):
    ...
    def __init__(self):
        ...
        self.pub_traffic_state = self.create_publisher(String, '/traffic_light/state', 1)
    ...
    def publish_traffic_state(self, color: str):
        msg = String()
        msg.data = color.upper()
        self.pub_traffic_state.publish(msg)
        self.get_logger().info(f'Published traffic state: {msg.data}')
    ...
    def find_traffic_light(self):
        ...
        self.publish_traffic_state('yellow')  # 추가
        state_published = True
        ...
        self.publish_traffic_state('green')   # 추가
        state_published = True
